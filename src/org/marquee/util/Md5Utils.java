...
public class Md5Utils {
	...
	private static String leftPad(String src, char c, int num) {
		char[] cs=new char[num];
		Arrays.fill(cs, c);
		System.arraycopy(src.toCharArray(), 0, cs, cs.length-src.length(), src.length());
		return src.toString();
	}
	public static void main(String[] args) {
		System.out.println(md5("dzw123"));
	}
